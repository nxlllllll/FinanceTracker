...
public sealed class RecurringTransactionListenerService(
    RabbitMqConnectionFactory connectionFactory,
    IOptions<RabbitMqOptions> options,
    IServiceScopeFactory scopeFactory,
    ILogger<RecurringTransactionListenerService> logger
) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken ct)
    {
        ...
        consumer.ReceivedAsync += async (_, ea) =>
        {
            ...
            RecurringTransactionConsumer handler = scope.ServiceProvider.GetRequiredService<RecurringTransactionConsumer>();
