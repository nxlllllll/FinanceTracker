...
namespace FinanceTracker.Tests.Integration.Infrastructure.Repositories.Operation;
...
public sealed class OperationsWriteRepositoryTests : DatabaseFixture
{
	...
	private static Core.Domains.Transfer.Transfer CreateTransfer(
		Guid userId,
		Guid fromAccountId,
		Guid toAccountId,
		string? description = null)
	...
	public async Task UpdateCategoryAsync_ShouldUpdateCategoryIdInPayload()
	{
		...
		Guid newCategoryId = await _categoryBuilder.CreateAsync(userId: userId, name: "новая");
