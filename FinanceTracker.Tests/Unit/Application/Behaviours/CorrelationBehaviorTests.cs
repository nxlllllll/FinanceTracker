...
public sealed class CorrelationBehaviorTests
{
	...
	[Test]
	public async Task Handle_WhenCorrelationIdIsEmpty_ShouldNotSetOnContext()
	{
		...
		_context.DidNotReceive().Set(correlationId: Arg.Any<Guid>());
	}

	[Test]
	public async Task Handle_WhenCommandDoesNotHaveCorrelationId_ShouldNotSetOnContext()
	{
