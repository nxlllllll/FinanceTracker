...
public sealed class AccountTests
{
	...
	public async Task Rename_WithNewName_ShouldChangeName()
	{
		...
		_ = account.Rename(occurredAt: Now, newName: Name.Create(value: "����� ��������").Value);
	...
	{
		Account account = AccountFactory.Create(name: "����� ����").Value!;
		account.ClearEvents();
		
		account.Rename(occurredAt: Now, newName: Name.Create(value: "����� ����").Value);
