...
public sealed class GetUnresolvableEventsQueryValidator : AbstractValidator<GetUnresolvableEventsQuery>
{
	public GetUnresolvableEventsQueryValidator()
	{
		RuleFor(x => x.PageSize).InclusiveBetween(from: 1, to: 100).WithMessage(errorMessage: "The page size should be from 1 to 100.");
