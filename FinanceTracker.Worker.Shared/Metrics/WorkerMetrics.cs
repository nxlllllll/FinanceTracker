...
public static class WorkerMetrics
{
	...
	// outbox.pending Ч сколько сообщений ждут отправки
	...
	// outbox.published Ч счЄтчик успешно опубликованных
	...
	// outbox.failed Ч счЄтчик перешедших в dead letter
	...
	// dead_letter.count Ч текущее количество в dead letter
	...
	// message.processing.duration Ч гистограмма времени обработки
	...
	// transfer.credit.pending Ч сколько трансферов без кредита
	// Eventual consistency: дебет и кредит примен€ютс€ в разных транзакци€х.
	// ≈сли это значение > 0 дольше нескольких минут Ч кредитный воркер завис или упал.
	...
	// transfer.credit.duration Ч врем€ от дебета до применени€ кредита
